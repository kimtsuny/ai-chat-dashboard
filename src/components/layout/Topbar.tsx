    ...
    <header className="flex items-center justify-between h-14 px-2 pt-3 pb-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <Button
          ...
          size="icon"
          onClick={onMenuClick}
          className="text-[#9ca3af] hover:text-[#f3f4f6] hover:bg-[#1e1e24] transition-colors"
        >
          <Menu className="w-5 h-5" />
        </Button>

        <h1 className="font-semibold text-lg md:hidden bg-gradient-to-r from-[#8b5cf6] to-purple-400 bg-clip-text text-transparent">
          Universe
        </h1>
        ...
        {loading ? null : user ? (
          ...
          <DropdownMenu>
            ...
            <DropdownMenuTrigger asChild>
              ...
              <button className="flex items-center gap-4 rounded-full hover:bg-[#1e1e24] px-2 py-1 transition-all duration-200">
                ...
                <Avatar className="h-8 w-8 ring-2 ring-[#2e2e36]">
                  ...
                  <AvatarFallback className="bg-[#24242b] text-[#f3f4f6]">
                    U
                  </AvatarFallback>
                </Avatar>
            ...
            <DropdownMenuContent align="end" className="w-52 bg-[#1e1e24] border-[#2e2e36]">
              ...
              <DropdownMenuItem
                className="text-[#9ca3af] hover:text-[#f3f4f6] focus:bg-[#24242b] focus:text-[#f3f4f6] cursor-pointer"
              ...
              <DropdownMenuItem
                className="text-red-400 focus:bg-[#24242b] focus:text-red-400 cursor-pointer"
                onClick={async () => {
